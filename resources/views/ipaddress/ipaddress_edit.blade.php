                    ...
                    <div class="row pb-5 d-flex justify-content-center">
                        <div class="col-xl-10">
                            ...
                            <div class="card mb-4">
                                ...
                                @endif
                                <div class="card-body">
                                    <form method="POST" action="{{ route('ipaddress.update', $device[0]->id) }}">
                                        @method('PUT')
                                        @csrf
                                        <x-adminlte-input name="device" label="Device" value="{{ old('device') ?? $device[0]->device }}"
                                            placeholder="Device" label-class="text-lightblue">
                                        ...
                                        <x-adminlte-input name="ip_address" label="IP Address" value="{{ old('ip_address') ?? $device[0]->ip_address }}"
                                            placeholder="xxx.xxx.xxx.xxx" label-class="text-lightblue">
                                            <x-slot name="prependSlot">
                                                <div class="input-group-text">
