            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Register - {{Carbon\Carbon::now()->subMonth()->translatedFormat('F');}}</li>
                    </ol>
...
@section('js')
    ...
    <script>
        function exportSelectedRows() {
            ...
            var formattedDateTime = currentDate.toISOString().slice(0, 19).replace("T", "_").replace(/\s/g, '_').replace(
