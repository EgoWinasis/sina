                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <x-adminlte-input required name="nama_debitur" label="Debitur"
                                                    value="{{ old('nama_debitur') }}" placeholder="Nama Debitur"
                                                    label-class="text-lightblue">
                                                    <x-slot name="prependSlot">
                                                        <div class="input-group-text">
                                                ...
                                                <x-adminlte-input required name="nik_debitur" label="NIK" type="number"
                                                    min=0 value="{{ old('nik_debitur') }}" placeholder="NIK"
                                                    label-class="text-lightblue">
                                                    <x-slot name="prependSlot">
                                                        <div class="input-group-text">
                                                ...
                                                <x-adminlte-input required name="tgl_lahir_debitur" class="tanggalInput" label="Tanggal Lahir"
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <x-adminlte-input name="tgl_lahir_penjamin" class="tanggalInput" label="Tanggal Lahir"
